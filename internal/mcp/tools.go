...
func RegisterTools(s *server.MCPServer) {
	s.AddTool(
		mcplib.NewTool("site_get-nba-scoreboard",
			mcplib.WithDescription("Return the current NBA scoreboard payload from ESPN. Returns the SiteGetNbaScoreboardResponse."),
	...
	s.AddTool(
		mcplib.NewTool("site_get-nba-summary",
			mcplib.WithDescription("Return an NBA game's summary and box score from ESPN. Required: event. Returns the SiteGetNbaSummaryResponse."),
			mcplib.WithString("event", mcplib.Required(), mcplib.Description("ESPN event id from the NBA scoreboard payload.")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
	...
	s.AddTool(
		mcplib.NewTool("site_get-ncaab-scoreboard",
			mcplib.WithDescription("Return the current NCAA men's basketball scoreboard payload from ESPN. Returns the SiteGetNcaabScoreboardResponse."),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
	...
	s.AddTool(
		mcplib.NewTool("site_get-ncaab-summary",
			mcplib.WithDescription("Return an NCAA men's basketball game's summary and box score from ESPN. Required: event. Returns the SiteGetNcaabSummaryResponse."),
			mcplib.WithString("event", mcplib.Required(), mcplib.Description("ESPN event id from the NCAA basketball scoreboard payload.")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
	...
	s.AddTool(
		mcplib.NewTool("site_get-ncaaf-scoreboard",
			mcplib.WithDescription("Return the current NCAA football scoreboard payload from ESPN. Returns the SiteGetNcaafScoreboardResponse."),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
	...
	s.AddTool(
		mcplib.NewTool("site_get-ncaaf-summary",
			mcplib.WithDescription("Return an NCAA football game's summary and box score from ESPN. Required: event. Returns the SiteGetNcaafSummaryResponse."),
			mcplib.WithString("event", mcplib.Required(), mcplib.Description("ESPN event id from the NCAA football scoreboard payload.")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
	...
	s.AddTool(
		mcplib.NewTool("site_get-nfl-scoreboard",
			mcplib.WithDescription("Return the current NFL scoreboard payload from ESPN. Returns the SiteGetNflScoreboardResponse."),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
	...
	s.AddTool(
		mcplib.NewTool("site_get-nfl-summary",
			mcplib.WithDescription("Return an NFL game's summary and box score from ESPN. Required: event. Returns the SiteGetNflSummaryResponse."),
			mcplib.WithString("event", mcplib.Required(), mcplib.Description("ESPN event id from the NFL scoreboard payload.")),
			mcplib.WithReadOnlyHintAnnotation(true),
			mcplib.WithDestructiveHintAnnotation(false),
			mcplib.WithOpenWorldHintAnnotation(true),
		),
		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 401"):
				return mcplib.NewToolResultError("authentication failed: " + msg +
					...
					"\n      Run 'espn-sports-pp-cli doctor' to check auth status."), nil
...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "espn-sports-pp-cli", "config.toml")
