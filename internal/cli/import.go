...
but do not stop the import.`,
  ...
  espn-sports-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  espn-sports-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | espn-sports-pp-cli import <resource> --input -`,
