...
Exit codes & warnings:
  ...
  espn-sports-pp-cli sync

  # Sync specific resources only
  espn-sports-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  espn-sports-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  espn-sports-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  espn-sports-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  espn-sports-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("espn-sports-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/espn-sports-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		"site",
		"site-v2-sports-basketball-mens-college-basketball-scoreboard",
		"site-v2-sports-baseball-mlb-scoreboard",
		"site-v2-sports-basketball-nba-scoreboard",
		"site-v2-sports-football-college-football-scoreboard",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"site":                                   "/apis/site/v2/sports/football/nfl/scoreboard",
		"site-v2-sports-baseball-mlb-scoreboard": "/apis/site/v2/sports/baseball/mlb/scoreboard",
		"site-v2-sports-basketball-mens-college-basketball-scoreboard": "/apis/site/v2/sports/basketball/mens-college-basketball/scoreboard",
		"site-v2-sports-basketball-nba-scoreboard":                     "/apis/site/v2/sports/basketball/nba/scoreboard",
		"site-v2-sports-football-college-football-scoreboard":          "/apis/site/v2/sports/football/college-football/scoreboard",
	}
