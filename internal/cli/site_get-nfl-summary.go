...
func newSiteGetNflSummaryCmd(flags *rootFlags) *cobra.Command {
	var flagEvent string

	cmd := &cobra.Command{
		Use:   "get-nfl-summary",
		Short: "Return an NFL game's summary and box score from ESPN.",
		Example: "  espn-sports-pp-cli site get-nfl-summary --event example-value",
		Annotations: map[string]string{"pp:endpoint": "site.get-nfl-summary", "pp:method": "GET", "pp:path": "/apis/site/v2/sports/football/nfl/summary", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagEvent, "event", "", "ESPN event id from the NFL scoreboard payload.")
