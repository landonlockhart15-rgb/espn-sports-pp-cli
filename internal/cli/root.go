...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "espn-sports-pp-cli",
		Short: "Manage espn-sports resources via the espn-sports API",
		Long: `Manage espn-sports resources via the espn-sports API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'espn-sports-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("espn-sports-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'espn-sports-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("espn-sports-pp-cli %s\n", version)
		},
	}
}
